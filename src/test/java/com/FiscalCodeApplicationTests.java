...
public class FiscalCodeApplicationTests {
	...
	public void cityRepositoryFindAllTest() {
		assertThat(this.cityRepository.findAll()).isNotNull();
	}
	...
	public void cityRepositoryFindByCityNameTest(String name, String state) {
		assertThat(this.cityRepository.findByName(name, state)).isNotNull();
	}
	...
	public void cityRepositoryFindByInvalidCityNameTest(String name, String state) {
		assertThat(this.cityRepository.findByName(name, state)).isEqualTo(Optional.empty());
	}
